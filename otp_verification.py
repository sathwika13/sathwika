...
Original file is located at
    https://colab.research.google.com/drive/1I1yu3IfLeJ3axCKCe0QkeY6FCijoLk0q
...
To generate a 6-digit OTP and send it via email for verification, we will use the random library .
 The stmplib library to send the email. For this example, we'll use a Gmail account to send the email.
 Remember to replace your mail id
